...
@onready var unit_4_red = $unit_4_red
@onready var unit_4_blue = $unit_4_blue
...
func init_unit(_id: int, _color: bool, _position: Vector2) -> void:
	...
	if player_color == false:
		unit_type = $unit_4_red
		unit_type_outline = $red_outline
		#print("Red unit of type 4 with id: ", unit_id, " added")
	else:
		unit_type = $unit_4_blue
		unit_type_outline = $blue_outline
		#print("Blue unit of type 4 with id: ", unit_id, " added")
